package net.ittimeline.pandora.framework.mybatis.config;
...
import net.ittimeline.pandora.framework.mybatis.core.handler.DefaultDBFieldHandler;
 ...
 * @version 2026/5/16 23:35
 * @since Java 25
 */
@AutoConfiguration(before = MybatisPlusAutoConfiguration.class) // 目的：先于 MyBatis Plus 自动配置，避免 @MapperScan 可能扫描不到 Mapper 打印 warn 日志
@MapperScan(value = "${pandora.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class PandoraMybatisAutoConfiguration {
    static {
