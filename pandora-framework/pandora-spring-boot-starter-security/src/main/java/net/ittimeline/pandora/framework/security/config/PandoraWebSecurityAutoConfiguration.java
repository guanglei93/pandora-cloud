...
import static net.ittimeline.pandora.framework.common.util.foundational.collection.CollectionUtils.convertList;

/**
 * 自定义的 Spring Security 配置适配器实现
 *
 * @author tony 18601767221@163.com
 * @version 2026/5/16 21:10
 * @since Java 25
 */
@AutoConfiguration
@AutoConfigureOrder(-1) // 目的：先于 Spring Security 自动配置，避免一键改包后，org.* 基础包无法生效
@EnableMethodSecurity(securedEnabled = true)
public class PandoraWebSecurityAutoConfiguration {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(c -> c
                    ...
                    // 1.3 基于 pandora.security.permit-all-urls 无需认证
