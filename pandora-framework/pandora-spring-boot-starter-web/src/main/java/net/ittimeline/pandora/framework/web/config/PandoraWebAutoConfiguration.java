package net.ittimeline.pandora.framework.web.config;
...
import net.ittimeline.pandora.framework.web.core.filter.CacheRequestBodyFilter;
import net.ittimeline.pandora.framework.web.core.filter.DemoFilter;
import net.ittimeline.pandora.framework.web.core.handler.GlobalExceptionHandler;
import net.ittimeline.pandora.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class PandoraWebAutoConfiguration {
    ...
    /**
        ...
        */
       @Bean
       @Order(value = WebFilterOrderConstants.CORS_FILTER) // 特殊：修复因执行顺序影响到跨域配置不生效问题
        ...
        */
       @Bean
       @ConditionalOnProperty(value = "pandora.demo", havingValue = "true")
