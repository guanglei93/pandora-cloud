package net.ittimeline.pandora.framework.swagger.config;
...
import static net.ittimeline.pandora.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class PandoraSwaggerAutoConfiguration {
    // ========== 全局 OpenAPI 配置 ==========
