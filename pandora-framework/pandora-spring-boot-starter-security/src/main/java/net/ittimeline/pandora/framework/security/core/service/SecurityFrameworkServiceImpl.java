package net.ittimeline.pandora.framework.security.core.service;
...
import net.ittimeline.pandora.framework.common.core.KeyValue;
...
import static net.ittimeline.pandora.framework.common.util.web.cache.CacheUtils.buildCache;
import static net.ittimeline.pandora.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
import static net.ittimeline.pandora.framework.security.core.util.SecurityFrameworkUtils.skipPermissionCheck;

/**
 * 默认的 {@link SecurityFrameworkService} 实现类
 *
 * @author tony 18601767221@163.com
 * @version 2026/5/16 20:53
 * @since Java 25
 */
@AllArgsConstructor
